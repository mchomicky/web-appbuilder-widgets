  ...
  var clazz = declare([BaseDijitSetting, _WidgetsInTemplateMixin, Evented], {
    ...
    _setConfig: function(config) {
      ...
      var clusterField, valueFields, operation, dateConfig,
        sortOrder, maxLabels, nullValue, axisMin;
      if (data) {
      ...
      if (typeof axisMin !== 'undefined') {
        this.defaultMinBtn.setChecked(axisMin);
        this.dataMinBtn.setChecked(!axisMin);
      }
    ...
    getConfig: function(check) {
      ...
      enumValues.axisMin = this.dataMinBtn.checked;
      ...
      var xValueAxis = utils.isValueAxis(true, type);
      ...
      //format type
      var yFormat = {};
      var yValueAxis = utils.isValueAxis(false, type);
      ...
      chartConfig.data.axisMin = enumValues.axisMin;
