...
define([
  ...
  var clazz = declare([BaseDijit], {
    ...
    startRendering: function() {
      ...
      this.chartOption.axisMin ? this.chart.updateConfigDataMin(this.chartOption) : this.chart.updateConfig(this.chartOption);
      this.chart.resize();
    },
    ...
    _createJimuChart: function() {
      ...
      this.chart.updateConfigDataMin = function(config) {
